...
function Map:update(event)
    ...
    while i < event:vertexcount() do
        ...
        local isplayericon = helpers.iscorrecttexture(event, i, playericon.w, playericon.h, playericon.offset, playericon.data)
...
function Map:setRoomKeys(event)
    ...
    local lockedroomcoords = { x = roomcoords.x + doordirectionfromcenter.x, y = roomcoords.y + doordirectionfromcenter.y}
